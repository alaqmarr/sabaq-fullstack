    ...
    return (
        <Card className="w-full max-w-md border-destructive/20 shadow-2xl relative overflow-hidden backdrop-blur-xl bg-background/80">
            ...
            <CardHeader className="text-center pb-2">
                ...
                {code && (
                    <div className="mt-2">
                        <span className="px-2 py-1 rounded text-xs font-mono font-bold bg-destructive/10 text-destructive border border-destructive/20">
                            Error Code: {code}
                        </span>
                    </div>
                )}
            ...
            <CardContent className="text-center space-y-4 pt-2">
                <div className="p-4 bg-destructive/5 rounded-lg border border-destructive/10">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        {reason || "Your attempt to access this resource has been blocked and this activity has been flagged for security review."}
                    </p>
                </div>
