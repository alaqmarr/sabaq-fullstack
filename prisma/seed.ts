...
async function main() {
  ...
  // Create Locations
  const locations = [
    { name: 'Masjid-e-Saifee', address: '123 Main St', lat: 19.0760, lng: 72.8777 },
    { name: 'Burhani Masjid', address: '456 Park Ave', lat: 19.0800, lng: 72.8800 },
  ];
  ...
  for (const sabaq of sabaqs) {
    ...
    if (location) {
        ...
        create: {
            ...
            enrollmentEndsAt: new Date(new Date().setMonth(new Date().getMonth() + 1)),
